...
# [Fundamentals]{.bold .r-fit-text .text-color-latte} {.bg-purple}
...
# [A record of a change]{.bold .r-fit-text .text-color-latte} {.bg-purple}
...
# [Remote]{.bold .r-fit-text .text-color-latte} {.bg-purple}
...
# [Merge conflict]{.bold .r-fit-text .text-color-latte} {.bg-purple}
...
A [merge conflict]{.text-background-purple} can occur when you are changing the [same line]{.text-background-wisteria} in one file [differently](.text-background-latte).
...
[Variant A]{.text-background-purple}: I commited but **NOT** [pushed yet]{.text-background-latte}.
...
Write [Git: Undo Last Commit]{.text-background-latte}
...
[Variant B]{.text-background-wisteria}: I commited but **AND** [pushed already]{.text-background-latte}.
...
Right-click on the commit you would like to undo to and select [Revert a commit]{.text-background-latte}.
...
In the [Source control]{.text-background-wisteria} panel -> **COMMITS** section -> Right-click on the commit you want to revert to -> Select the [Reset Current Branch to Previous Commit]{.text-background-latte}
...
# [Branches]{.r-fit-text .text-color-latte} {.bg-purple .text-center}
...
Swithching between branches is sometimes called  ([checkout]{.text-background-latte})
...
Now you can [more commits]{.text-background-purple} on GitHub, (add [Comment]{.text-background-wisteria} to start discussion), or [merge]{.text-background-latte} the branch.
...
Select [Git: Delete branch ...]{.text-background-latte}
